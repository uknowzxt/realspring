...
import com.uknowzxt.beans.factory.config.AutowireCapableBeanFactory;
import com.uknowzxt.beans.factory.config.InstantiationAwareBeanPostProcessor;
import com.uknowzxt.core.annotation.AnnotationUtils;
import com.uknowzxt.util.ReflectionUtils;
...
/**
 * 通过遍历字段, 拿到实体类的字段, 拿到字段上面的注解, 如果是列表里面的注解, 返回这个注解. 注解不为空的, 创建AutowiredFieldElement 对象, 加入elements.  最终创建InjectionMetadata对象返回
 */
